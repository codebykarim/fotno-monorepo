  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <StatCard
          title="Galleries"
          value={formatNumber(data.totalGalleries)}
          icon={Image}
        />
        <StatCard
          title="Photos"
          value={formatNumber(data.totalPhotos)}
          icon={Camera}
        />
        <StatCard
        ...
        />
        <StatCard
          title="New Galleries (Month)"
          value={formatNumber(data.newGalleriesThisMonth)}
          icon={ImagePlus}
        />
        <StatCard
          title="Uploads (Week)"
          value={formatNumber(data.uploadsThisWeek)}
          icon={Upload}
        />
        <StatCard
          title="Storage Used"
          value={formatBytes(data.platformStorageUsed)}
          icon={HardDrive}
        />
      </div>
