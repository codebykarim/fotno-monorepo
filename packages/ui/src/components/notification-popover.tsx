  ...
  return (
    <div className={`relative ${textColor}`} ref={ref}>
      ...
      >
        <Bell size={16} />
        {unreadCount > 0 && (
          <div className="absolute -top-1 -right-1 w-5 h-5 z-50 bg-destructive rounded-full flex items-center justify-center text-xs border border-destructive text-destructive-foreground">
            {unreadCount}
          </div>
        )}
      </Button>
