...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-background sm:text-7xl">
        FOTNO{" "}
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-background">
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        >
          <svg
            aria-hidden="true"
            className="h-3 w-3 flex-none fill-secondary group-active:fill-current"
          >
