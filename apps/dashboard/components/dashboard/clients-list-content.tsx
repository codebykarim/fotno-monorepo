        ...
        {!isLoading &&
          data?.clients.map((client) => (
            <motion.div key={client.id} variants={staggerItem}>
              <div className="rounded-xl border border-border/50 bg-card p-4 space-y-3 transition-colors duration-200 hover:border-primary/20">
                {editingClientId === client.id ? (
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1.5">
                      <p className="text-xs font-medium text-muted-foreground">Galleries</p>
                      {allGalleries.map((gallery) => (
                        <label
                          key={gallery.id}
                    ...
                    <div className="flex gap-2 pt-1">
                      ...
                      <Button size="sm" onClick={saveClient} className="flex-1">
                        Save
                      </Button>
                    </div>
                  </div>
